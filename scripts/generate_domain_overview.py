...
generates a rich static HTML domain-overview page at:
  <repo>/docs/specifications/domain-overview.html

Run from a spec repo via:  task docs:generate
Run from the suite via:    python scripts/generate_domain_overview.py --repo <path>
"""
...
def _parse_args():
    parser = argparse.ArgumentParser(
        description="Generate the domain-overview HTML page for a spec repo.",
    )
    parser.add_argument(
        "--repo",
        default=".",
        help="Path to the spec repo (default: current working directory).",
    )
