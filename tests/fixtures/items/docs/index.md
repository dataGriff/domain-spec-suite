...
requirements, rules, and contracts of the Items domain.
...
[implementation guide](https://github.com/dataGriff/domain-api-template/blob/main/.github/instructions/api-implementation.instructions.md)
